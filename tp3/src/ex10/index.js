...
var library_1 = require("./services/library");
var api_1 = require("./services/api");
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var booksRepo, library, books, borrowed;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    booksRepo = new repository_1.Repository();
                    library = new library_1.Library(booksRepo);
                    return [4 /*yield*/, (0, api_1.fetchBooks)()];
                case 1:
                    books = _a.sent();
                    books.forEach(function (book) { return library.addBook(book); });
                    console.log("Tous les livres:");
                    console.log(library.booksRepo.getAll());
                    borrowed = library.borrowBook(1);
